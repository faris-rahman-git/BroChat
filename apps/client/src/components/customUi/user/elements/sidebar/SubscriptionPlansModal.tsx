...
const SubscriptionPlansModal = ({
  ...
  const handleSubscribe = async (feature: PaymentType, amount: number) => {
    console.log('test');
    onClose();
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="border rounded-xl p-6 shadow hover:shadow-lg transition-all flex flex-col justify-between bg-gray-50">
            <div>
              ...
              <p className="text-xs text-center text-gray-500 mb-4">
                Perfect for trying things out or short-term needs
              </p>
              ...
              <div className="grid gap-3 pb-5 text-sm text-gray-700">
                ...
                <div className="flex items-start gap-2">
                  <span className="text-blue-600 font-medium mt-0.5">✔</span>
                  <span>
                    <strong className="font-semibold"> Just ₹99/month!</strong>
                  </span>
                </div>
              </div>
            </div>
            ...
            <Button
              onClick={() => handleSubscribe('monthly', 99)}
              className="w-full"
            >
              Upgrade Now –{' '}
          ...
          <div className="border rounded-xl p-6 shadow hover:shadow-lg transition-all flex flex-col justify-between bg-gray-50">
            <div>
              ...
              <p className="text-xs text-center text-gray-500 mb-4">
                Best for uninterrupted experience & long-term value
              </p>
              <div className="grid gap-3 pb-5 text-sm text-gray-700">
                <div className="flex items-start gap-2">
                  <span className="text-blue-600 font-medium mt-0.5">✔</span>
                ...
                <div className="flex items-start gap-2">
                  <span className="text-blue-600 font-medium mt-0.5">✔</span>
                  <span>
                    <strong className="font-semibold">Save ₹189</strong>{' '}
                    compared to monthly
                  </span>
                </div>
              </div>
            ...
            <Button
              onClick={() => handleSubscribe('yearly', 999)}
              className="w-full"
            >
              Upgrade Now –{' '}
              <span className="text-gray-400 line-through text-sm">₹1199</span>
              <span className="text-green-500 font-semibold">₹999 Only</span>
            </Button>
          </div>
        </div>
