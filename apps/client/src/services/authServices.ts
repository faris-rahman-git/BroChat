...
import type { ForgotPasswordSchemaType, LoginSchemaType, RegisterSchemaType , OtpAndPasswordSchemaType} from "@bro/shared";
...
export const otpAndPasswordApi = async ({data , mode} : {data: OtpAndPasswordSchemaType & RegisterData , mode: string }) => {
  if(mode === "register"){
