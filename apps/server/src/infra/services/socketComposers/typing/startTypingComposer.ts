...
import { startTypingController } from '../../../../presentation/socket/controllers/typing/startTypingController';
import { IStartTypingUseCase } from '../../../../app/socketUseCase/typing/interfaces/IStartTypingUseCase';
import { StartTypingUseCase } from '../../../../app/socketUseCase/typing/implementations/StartTypingUseCase';

export function startTypingComposer(): ISocketController {
  ...
  const useCase: IStartTypingUseCase = new StartTypingUseCase(
    typingQueueRepo,
    eventQueueService
  );

  const controller: ISocketController = new startTypingController(useCase);
  return controller;
}
