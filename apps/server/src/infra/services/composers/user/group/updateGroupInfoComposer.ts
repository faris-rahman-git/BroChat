...
import { updateGroupInfoController } from '../../../../../presentation/http/controller/user/group/updateGroupInfoController';
import { IUpdateGroupInfoUseCase } from '../../../../../app/useCases/user/group/interfaces/IUpdateGroupInfoUseCase';
import { UpdateGroupInfoUseCase } from '../../../../../app/useCases/user/group/implementations/UpdateGroupInfoUseCase';
...
export function updateGroupInfoComposer(): IController {
  ...
  const useCase: IUpdateGroupInfoUseCase = new UpdateGroupInfoUseCase(
    conWriteRepo,
    checkAdminService,
    receiverService,
    eventQueueService
  ...
  const controller: IController = new updateGroupInfoController(useCase);
  return controller;
}
