...
export class getDeletedUsersController implements IController {
  constructor(
    private getDeletedUsersUseCase: IGetDeletedUsersUseCase,
  ...
  async handle(httpRequest: IHttpRequest): Promise<IHttpResponse> {
    ...
    try {
      ...
      response = await this.getDeletedUsersUseCase.execute(
        searchValue ?? '',
        page
      );
      ...
      console.error('Error in getDeletedUsersController:', error);
