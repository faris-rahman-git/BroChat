...
export class getAllPlansController implements IController {
  constructor(
    private getAllPlansUseCase: IGetAllPlansUseCase,
  ...
  async handle(httpRequest: IHttpRequest): Promise<IHttpResponse> {
    ...
    try {
      ...
      response = await this.getAllPlansUseCase.execute(selectedChild , userId);
