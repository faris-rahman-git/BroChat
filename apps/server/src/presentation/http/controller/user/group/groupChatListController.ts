...
export class groupChatListController implements IController {

  constructor(
    private groupChatListUseCase: IGroupChatListUseCase,
  ...
  async handle(httpRequest: IHttpRequest): Promise<IHttpResponse> {
    ...
    try {
      ...
      response = await this.groupChatListUseCase.execute(userId);
